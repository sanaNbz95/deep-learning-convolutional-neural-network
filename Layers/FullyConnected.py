...
class FullyConnected(BaseLayer):
    ...
    def initialize(self,weights_initializer, bias_initializer):
        # row wise
        self.weights = np.vstack((weights_initializer.initialize((self.input_size,self.output_size),self.input_size,self.output_size),bias_initializer.initialize((1,self.output_size),1,self.output_size)))
